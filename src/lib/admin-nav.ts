...
export const adminNav: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "بنك الأسئلة", href: "/admin/question-bank", icon: FileQuestion },
      { label: "الواجبات", href: "/admin/assignments", icon: ClipboardList },
      { label: "الإعلانات", href: "/admin/announcements", icon: Radio },
      { label: "التواصل الطلابي", href: "/admin/communications", icon: MessagesSquare },
      { label: "التقارير والتحليلات", href: "/admin/reports", icon: Table },
    ],
  },
  {
    ...
    items: [
      ...
      { label: "الشُعب والمجموعات", href: "/admin/cohorts", icon: Users },
      { label: "الفصول الدراسية", href: "/admin/academic-terms", icon: BookOpen },
      { label: "التقويم الأكاديمي", href: "/admin/calendar", icon: ListOrdered },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "الأمان والتشغيل", href: "/admin/system", icon: Settings, adminOnly: true },
