...
export const stages = [
  ...
  { key: "secondary", numAr: "المرحلة الثانوية", numEn: "Secondary stage", titleAr: "المرحلة الثانوية", titleEn: "Secondary Stage", metaAr: "مسارٌ دراسيّ · ١٠ مقرّرات", metaEn: "Academic track · 10 courses", descAr: "مرحلةٌ دراسيةٌ تأسيسية تجمع العلوم واللغات والمواد الإنسانية والتربية الدينية في مسارٍ متوازنٍ للطلاب.", descEn: "A foundational academic stage combining sciences, languages, humanities, and religious education in a balanced track for students.", items: { ar: ["الرياضيات", "الفيزياء", "الكيمياء", "التربية الدينية", "اللغة العربية", "اللغة الإنجليزية", "الأحياء", "التاريخ", "الجغرافيا", "الحاسوب وتقنية المعلومات"], en: ["Mathematics", "Physics", "Chemistry", "Religious Education", "Arabic Language", "English Language", "Biology", "History", "Geography", "Computer & IT"] }, icon: "i-stage", moreHref: "courses.html", order: 4 },
];
